...
const HeroSection = () => {
  return (
    ...
    <div className="w-[90%] text-white">
       <h1 className="text-5xl mb-4 text-center font-semibold">Transforming Your Care</h1>
      <p className="text-xl mb-4 text-center">Donate Your blood and save life</p>
      ...
      <div className="flex justify-center space-x-4">
        ...
        <button className="bg-transparent border-2 border-white hover:bg-white hover:text-black text-white font-bold py-2 px-4 rounded">
          Registered
        </button>
      </div>
    </div>
